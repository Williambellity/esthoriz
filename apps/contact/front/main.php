			...
			if (!$resp->is_valid) {
				...
				if (!empty($erreurs)) {
					...
					if (!$this->model->createMail($mailData)) {
						...
						$mail->FromName = 'Forum Est-Horizon 2013';
						$mail->Subject = 'Votre demande de contact pour le Forum Est-Horizon 2013';
						$mail->Body = "<h1>Votre demande de contact pour le Forum Est-Horizon 2013</h1>
						...
						<h2>Le Forum Est-Horizon 2013</h2>";
						$mail->IsHTML(true);
