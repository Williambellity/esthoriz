...
class InscriptionModel {
    ...
    @copy($tmp_name,"/home/esthoriz/www/CV2021/".$data['mail'].".pdf");
		...
		include LIBS_DIR.'phpmailer'.DS.'class.phpmailer.php';
						...
						<p>Vous trouverez aussi en piece jointe un QRcode renvoyant vers votre CV a presenter le jour du forum. Celui-ci ne fonctionne que si vous avez enregistre votre CV lors de votre inscription sur le site. </p>
						L\'equipe du Forum Est-Horizon
						');
