...
class InscriptionModel {
    ...
    @copy($tmp_name,"/home/esthoriz/www/Appli/CV/".$data['mail'].".pdf");
		...
		include LIBS_DIR.'phpmailer'.DS.'class.phpmailer.php';
						...
						$mail->Body = utf8_encode('Bonjour, </br></br>Nous vous remercions pour votre inscription au Forum Est-Horizon du jeudi 19 Novembre 2020.</br>
						...
						Vous trouverez aussi en pi�ce jointe un QRcode � pr�senter le jour du forum. Celui-ci sera aussi disponible sur notre application.
