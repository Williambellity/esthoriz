...
class LogisticModel {
	...
	*/
	...
	public function getReducs() {
		$str = "";
		$query = "SELECT reducs_id FROM logistic_reduc WHERE firmid = :firmid";
		$sth = $this->db->prepare($query);
		$sth->bindParam(':firmid',$_SESSION['firmid'], PDO::PARAM_INT);
		$sth->execute();
...
/////////////////////////***********************************///////////////////////////////////////////				
	...
	public function get_firm_Lot_value($lots,&$str) {
	...
	*/
	...
	public function get_firm_Option_value(&$options, &$str) {
	...
	*/
	...
	public function get_firm_Stand_value(&$stands,&$str) {
	...
	*/
	...
	public function get_firm_Accessoire_value(&$accessoires,&$str) {
	...
	public function get_firm_Color_value(&$str) {
